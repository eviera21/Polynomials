...
public interface List<E> extends Iterable<E> {
	 ...
	 * @return true if the element is remove, or an IndexOutOfBoundsException if the
	 *         index is invalid.
	 */
	 ...
	 * @return element at position index, or IndexOutOfBoundsException if the index
	 *         is invalid
	 */
	 ...
	 * @return the old value at position index, or IndexOutOfBoundsException if the
	 *         index is invalid
	 */
	 ...
	 * @return index of first position where element obj is found, or -1 if not
	 *         found
	 */
